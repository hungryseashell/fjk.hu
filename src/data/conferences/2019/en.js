    ...
    speakers: {
      ...
      speakers: [
        ...
        },
        {
          ...
          name: 'Ernő Ősz-Farkas',
          description: 'President of the Duna Conference of the Hungarian Union',
          bio: 'I was born in Marosvásárhely in 1966. I specialised in chemistry-biology in secondary school. I graduated at the Faculty of Pharmacy of the University of Medicine in Kolozsvár. I worked as a pastor after graduating at the Adventist Theology College (Budapest). I spent four months in California in 1998 where I studied nutrition science, public health and mental hygiene. I also participated in a course and a clinical practice based on lifestyle therapy at the Weimar Institution. I have been the national leader of the Department of Health Services in the Seventh-day Adventist Church since 1994, and lecturer at the Adventist Theology College since 1999. I teach Bioethics on the Lifestyle and Pastoral Counselling specialised training, and also teach subjects like Bible &amp; Health, and Christian Lifestyle. I was the chief editor of Boldog Élet (Happy Life) Magazine from 2000 to 2005. After that I became the communication manager of the magazine. I served as a general secretary in the Hungarian Union from 2004 to 2008. Since 2008, I have been president of the Duna Conference of the Hungarian Union.<br>I continued my studies at Newbold College and the University Of Wales (UWTSD) in the field of theology and management science. I finished the training on 31 st December 2018. My research area is the reunion of 2015 (between 700 KERAK (Christian Adventist Community) members and the Seventh-day Adventist Church). My wife, Krisztina is a piano teacher. We have 3 children, Ábel, Kincső and Mátyás.'
        },
        {
          img: '/img/milan-moskala.jpg',
          name: 'Milan Moskala',
          description: '',
          bio: 'Milan Moskala is a Czech dentist-missionary. He worked in Bangladesh for 17 years as an employee of the General Conference. He founded churches as well as schools besides his work as a dentist. He organized revival meetings in Dhaka, Myanmar, Cambodia, Zimbabwe and Kenya. He is now retired, but his enthusiasm for God’s work hasn’t waned. He gets numerous invitations as a presenter from churches and lifestyle clubs in Czech Republic,  Slovakia and other countries. He has also been to Miskolc, Hungary, where he had a great impact on the brothers and sisters living there.<br>„From my childhood I am desiring to be missionary and to help poor people abroad where there is nobody but only Jesus with me to go forward and to proclaim Everlasting Gospel and to preach Three Angels message. Banana project came to my mind on prayer. It is God&#39;s project and is very successful. All children young and adult are receiving great blessing from bananas, physically and spiritually as well. Their strength is improving, their ability to study is increasing. Banana is good source of vitamins and minerals. I see great blessing for children when they are receiving regularly minimum one bananas per day. Their health condition is much improved when they are accepting minimum one banana per day and during short period of time you can see difference and His appearance and in his health condition. I am very thankful to our Lord who gave this idea of feeding slum children with bananas and I see it is very good source of very nutritional elements which small children need so much.”<br>You will hear more from the Banana-project on the Conference. :)'
        },
        {
          img: '/img/jonathan-ostrowski.jpg',
          name: 'Jonathan Ostrowski',
          description: '',
          bio: 'He has worked in Adventist health destinations in Norway, the US and consults in health destination, and hospitality management. He is currently studying in Poland, but is born and raised in Australia. He is an ambassador for Hyvecamp and is passionate about seeing new  and innovating ways that entrepreneurs can make a real difference in the world while sharing the gospel. He enjoys running, sauna and good food with friends.'
        },
        {
          img: '/img/horvath-gabor.jpg',
          name: 'Gábor Horváth',
          description: 'Pastor, music instructor',
          bio: 'My most important roles and duties: husband, father and child of God. :)<br>My qualifications: pastor, educator, addiction counsellor, and in a leadership role at Reménység Rehabilitációs Ház (Hope Rehabilitation Center). Between 2002 and 2010, the focus of my ministry were young people. I have also been serving addicts and their family members for thirteen years. I live in Nágocs with my wife, two sons and daughter, where my job involves alcohol-, drug-, and gambling addictions. Other fields I am currently training and develop myself in are codependency, workaholism, screen-, and sex addiction. I have recently finished a 2 year training program as a family therapist.'
        }
      ]
    },
    seminars: {
